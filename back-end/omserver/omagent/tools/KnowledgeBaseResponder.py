...
folder_path = "omserver/omagent/tools/KnowledgeBaseResponder/knowledge_base"  
local_persist_path = "omserver/omagent/tools/KnowledgeBaseResponder"
md5_file_path = os.path.join(local_persist_path, "pdf_md5.txt")

class KnowledgeBaseResponder(BaseTool, OddMetaToolsBase):
    name = "KnowledgeBaseResponder"
    description = """此工具用于连接本地知识库获取问题答案，使用时请传入相关问题作为参数，例如：“RTCSDK支持哪些硬件平台和软件平台”"""
